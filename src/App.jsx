              ...
              .map((ele, index) => {
                ...
                return (
                  <ForecastDisplay
                    ...
                    temp={
                      toggleFormat
                        ? (Math.floor(ele.main.temp - 273.15) * 9) / 5 +
                          32 +
                          " °"
                        : Math.floor(ele.main.temp - 273.15) + " °"
                    }
            ...
            {data.weather && (
              <div className="details">
                <CurrentDetails
                  ...
                  value={
                    toggleFormat
                      ? (Math.floor(data.main.temp_min - 273.15) * 9) / 5 +
                        32 +
                        " °"
                ...
                <CurrentDetails
                  ...
                  value={
                    toggleFormat
                      ? (Math.floor(data.main.temp_max - 273.15) * 9) / 5 +
                        32 +
                        " °"
                ...
                <CurrentDetails
                  ...
                  value={
                    toggleFormat
                      ? (Math.floor(data.main.feels_like - 273.15) * 9) / 5 +
                        32 +
                        " °"
